...
# batch inference 
def gen_showers_batch_OLD(model, shower_flow, e_min, e_max, num=2000, bs=32, kdiffusion=False, config=None, max_points=6000, coef_real=None, coef_fake=None, n_scaling = True, n_splines=None):
