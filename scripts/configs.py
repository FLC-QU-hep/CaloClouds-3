...
class Configs(default.Configs):
    def __init__(self, **kwargs):
        ...
        self.Acomment = "Running on the calochallange dataset, first files"
        self._logdir = "dayhallh/point-cloud-diffusion-logs/investigation2/"
        ...
        self.shower_flow_data_dir = (
            "/data/dust/user/dayhallh/point-cloud-diffusion-data/investigation2/"
        )
