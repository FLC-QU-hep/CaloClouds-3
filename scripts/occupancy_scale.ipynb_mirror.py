...
from pointcloud.utils.plotting import *
...
#     real_showers[:, 1][idx] = metadata.layer_bottom_pos_global[i] + metadata.cell_thickness_global/2
...
n = 100_000
from pointcloud.utils.detector_map import create_map
