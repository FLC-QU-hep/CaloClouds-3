...
class Configs(default.Configs):
    def __init__(self, **kwargs):
        ...
        self.log_comet = True
        self.name = "CD_S2P_RegularSubcell_6kcut_"
        self.storage_base = "/eos/user/m/mamozzan/"
        self.latent_dim = 0  # no latent flow in new calocloud
        self.dataset_path_in_storage = True
        self.storage_base = "/eos/user/m/mamozzan/"
        self._dataset_path = "/eos/user/m/mamozzan/step2point/outputs/cc3input_merge_within_regular_subcell_6kcut/input_cc3_file_{}.h5"
