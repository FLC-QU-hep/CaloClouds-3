class Configs():
    ...
    # Experiment Name
        ...
        self.comet_workspace = 'mmozzani1'
        self.comet_graphics = True
    ...
    # Model arguments
        ...
        self.TSF_l_dim =  1 # Total dimension of the model (number of transformer blocks) NOTE: l_dim % num_layers ==0 !!
        self.TSF_hidden_dim = 256
        self.TSF_heads = 4

    # Data
        self.dataset = 'x36_grid' # choices=['x36_grid', 'clustered', 'getting_high', 'pions', 'Gauss_and_Spline']
        ...
        if self.dataset == 'pions': 
            self.dataset_path = '/beegfs/desy/user/mmozzani/Projects/pion_shower_newFinal_SoftCutNew.hdf5'
    ...
    # Gradient Accumulation for helping with the small batch size needed for the pion dataset 
        self.accumulation_steps = 4 # 1 for no accumulation
    ...
    # Others
        self.device = 'cuda'
        self.logdir = '/home/dayhallh/training/point-cloud-diffusion/martina'
        self.seed = 42
