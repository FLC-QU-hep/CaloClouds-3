...
from ..externals.lazy_ops import lazy_loading
...
def get_g4_data(path_or_config: str | Configs) -> tuple:
    ...
    Returns
    -------
    all_events : lazy_loading.DatasetView (n_events, max_num_hits, 4)
        The G4 events.
...
if __name__ == "__main__":
    ...
    # write_all_events(config, params_dict)
